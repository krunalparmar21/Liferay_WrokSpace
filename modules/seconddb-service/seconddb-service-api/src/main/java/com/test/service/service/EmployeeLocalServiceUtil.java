 ...
 * <code>com.test.service.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.test.service.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Employee createEmployee(int eid) {
	 ...
	 */
	public static Employee deleteEmployee(int eid) throws PortalException {
	...
	public static Employee fetchEmployee(int eid) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static Employee getEmployee(int eid) throws PortalException {
