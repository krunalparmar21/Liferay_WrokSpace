...
package com.test.service.service.persistence.impl;
...
import com.test.service.exception.NoSuchEmployeeException;
import com.test.service.model.Employee;
import com.test.service.model.EmployeeTable;
import com.test.service.model.impl.EmployeeImpl;
import com.test.service.model.impl.EmployeeModelImpl;
import com.test.service.service.persistence.EmployeePersistence;
import com.test.service.service.persistence.EmployeeUtil;
...
public class EmployeePersistenceImpl
	...
	public Employee[] findByUuid_PrevAndNext(
			int eid, String uuid, OrderByComparator<Employee> orderByComparator)
		throws NoSuchEmployeeException {

		uuid = Objects.toString(uuid, "");

		Employee employee = findByPrimaryKey(eid);
