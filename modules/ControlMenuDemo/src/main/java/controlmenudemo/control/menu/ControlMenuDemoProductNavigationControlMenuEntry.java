package controlmenudemo.control.menu;
...
@Component(
	...
	property = {
		...
		"product.navigation.control.menu.entry.order:Integer=2"
	},
	service = ProductNavigationControlMenuEntry.class
)
public class ControlMenuDemoProductNavigationControlMenuEntry
