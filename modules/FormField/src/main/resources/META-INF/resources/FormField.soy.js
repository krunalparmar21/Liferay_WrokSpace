...
// This file was automatically generated from FormField.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace FormField.
 * @public
 */

goog.module('FormField.incrementaldom');
...
$render.Params;
if (goog.DEBUG) {
  $render.soyTemplateName = 'FormField.render';
}
...
function $content(opt_data, opt_ijData, opt_ijData_deprecated) {
  ...
  var attributes__soy35 = function() {
    incrementalDom.attr('class', 'ddm-field-FormField form-control FormField');
...
$content.Params;
if (goog.DEBUG) {
  $content.soyTemplateName = 'FormField.content';
}
