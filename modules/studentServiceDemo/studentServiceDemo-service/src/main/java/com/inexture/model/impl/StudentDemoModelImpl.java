...
/**
 * The base model implementation for the StudentDemo service. Represents a row in the &quot;Demo_StudentDemo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class StudentDemoModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Demo_StudentDemo";
	...
	public static final String TABLE_SQL_DROP = "drop table Demo_StudentDemo";

	public static final String ORDER_BY_JPQL =
		" ORDER BY studentDemo.studentId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Demo_StudentDemo.studentId ASC";
	...
	static {
		...
		attributeGetterFunctions.put("uuid", StudentDemo::getUuid);
		attributeSetterBiConsumers.put(
			"uuid", (BiConsumer<StudentDemo, String>)StudentDemo::setUuid);
	...
	public Object clone() {
		...
		studentDemoImpl.setUuid(getUuid());
	...
	public StudentDemo cloneWithOriginalValues() {
		...
		studentDemoImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
	...
	public CacheModel<StudentDemo> toCacheModel() {
		...
		studentDemoCacheModel.uuid = getUuid();

		String uuid = studentDemoCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			studentDemoCacheModel.uuid = null;
		}
