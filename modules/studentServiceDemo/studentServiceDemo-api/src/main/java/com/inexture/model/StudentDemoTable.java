...
/**
 * The table class for the &quot;Demo_StudentDemo&quot; database table.
 *
...
public class StudentDemoTable extends BaseTable<StudentDemoTable> {
	...
	public final Column<StudentDemoTable, String> uuid = createColumn(
	...
	private StudentDemoTable() {
		super("Demo_StudentDemo", StudentDemoTable::new);
	}
